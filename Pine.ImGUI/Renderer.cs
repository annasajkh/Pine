...
public static class Renderer
{
    ...
    {
        Debug.Assert(context == nint.Zero);
    ...
    public static void BeginBatch(out Batcher batch, out Rect bounds)
    {
        ...
        // notify imgui
        ImGui.GetWindowDrawList().AddCallback(new nint(userBatches.Count), new nint(0));
    ...
    public static unsafe void Render()
    {
        ...
        // setup ortho matrix
        Matrix4x4 mat = Matrix4x4.CreateScale(data.FramebufferScale.X, data.FramebufferScale.Y, 1.0f) * Matrix4x4.CreateOrthographicOffCenter(0, size.X, size.Y, 0, 0.1f, 1000.0f);
    ...
    /// </summary>
    public static nint GetTextureID(Texture? texture)
    {
        var id = new nint(boundTextures.Count);
        if (texture != null)
